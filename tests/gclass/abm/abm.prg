       ...
       DEFINE WINDOW oWnd TITLE cTitle SIZE 300,300
         DEFINE BOX oBox OF oWnd VERTICAL
          ...
          DEFINE TABLE oTable ROWS 4 COLS 2 OF oBox
             ...
             DEFINE LABEL PROMPT "Married"      OF oTable TABLEATTACH 0,1,2,3 HALIGN GTK_LEFT
             ...
             DEFINE CHECKBOX TEXT "Married" VAR aValues[3] OF oTable  TABLEATTACH 1,2,2,3
