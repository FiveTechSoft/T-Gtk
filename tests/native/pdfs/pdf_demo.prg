   ...
   for nI := 1 to len( aFonts )
      ...
      for nJ := 1 to 4
         if aFonts[ nI ][ nJ + 1 ]
            ...
            pdfRJust("This is a test for " + aFonts[ nI ][ 1 ] + " " + aStyle[ nJ ], nK++, aReport[ REPORTWIDTH ], "R")
         endif
      next
...
/*   IF !pdfFilePrint( "test.pdf" ) // print .pdf file WITHOUT opening acrobat
      msgstop("Error running Acrobat Reader.")
   ENDIF
*/
return
