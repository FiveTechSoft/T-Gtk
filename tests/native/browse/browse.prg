 * $Id: browse.prg,v 1.1 2006-10-04 08:36:29 xthefull Exp $
 * Example T-Gtk 
...
/* Columna simple de texto creada con gtk_tree_view_column_new_with_attributes  */
 ...
 //  hColumn = gtk_tree_view_column_new_with_attributes(0, "Bitmap", "pixbuf", hRenderer )
   hColumn = gtk_tree_view_column_new_with_attributes( "Bitmap", hRenderer, {  "pixbuf", 0  }  )
   gtk_tree_view_append_column( hTree, hColumn )

/* Columna simple de texto creada paso a paso */
   hColumn = gtk_tree_view_column_new()
   gtk_tree_view_column_set_title( hColumn, "Paso a paso" )
...
/* Method Activate */
   gtk_window_set_title( hWnd, "Browse from T-Gtk for [x]Harbour (c)2005 Rafa Carmona" )
