/* $Id: t-gtkstock.ch,v 1.00 2022-06-20 14:27:00 riztan Exp $*/

/*
 * t-gtkstock.ch Fichero de definiciones de descontinuadas GtkStock -------------------------------------
 ...
 */
  ...
  #define GTK_STOCK_CAPS_LOCK_WARNING	"caps-lock-warning"
#endif

#ifdef GTK_STOCK_CDROM
  #undef GTK_STOCK_CDROM
  #define GTK_STOCK_CDROM            	"meia-optical"
#endif
  ...
  #define GTK_STOCK_CLOSE            	"windows-close"
#endif
...
//#define GTK_STOCK_EDIT             	"gtk-edit"
  ...
  #define GTK_STOCK_DIRECTORY		"folfer"
#endif
...
//#define GTK_STOCK_INDEX            	"gtk-index"
  ...
  #define GTK_STOCK_MEDIA_FORWARD    	"media-seek-forward"
#endif

#ifdef GTK_STOCK_MEDIA_NEXT
  #undef GTK_STOCK_MEDIA_NEXT
  #define GTK_STOCK_MEDIA_NEXT    	"media-skip-next"
#endif
  ...
  #define GTK_STOCK_MEDIA_PREVIOUS    	"media-skip-backward"
#endif
  ...
  #define GTK_STOCK_MEDIA_REWIND    	"media-seek-backward"
#endif
...
#define GTK_STOCK_NO               	"No"
  ...
  #define GTK_STOCK_PRINT_ERROR         	"printer-error"
#endif

#ifdef GTK_STOCK_PRINT_PREVIEW
  #undef GTK_STOCK_PRINT_PREVIEW
  #define GTK_STOCK_PRINT_PREVIEW    	"Pre view"
#endif
...
#ifdef GTK_STOCK_REMOVE_TO_SAVED
  #undef GTK_STOCK_REMOVE_TO_SAVED
...
//#define GTK_STOCK_SELECT_COLOR     	"gtk-select-coloddr"
