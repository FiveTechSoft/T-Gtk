 ...
 */
#define GTK_CELL_RENDERER_SELECTED		0
#define GTK_CELL_RENDERER_PRELIT		1
#define GTK_CELL_RENDERER_INSENSITIVE		2
#define GTK_CELL_RENDERER_SORTED		3
#define GTK_CELL_RENDERER_FOCUSED		4
