 /*
 * $Id: tmysql.prg,v 1.1 2006-09-15 12:58:15 xthefull Exp $
 */
...
/*
 2006-04-17 Rafa Carmona.
 Class TMySqlServer, method new():
   + New Param lEmbedded, for use server embedded
 */
...
METHOD New( cServer, cUser, cPassword, nPort, nFlags, lEmbedded ) CLASS TMySQLServer
   ...
   ::nPort     := nPort
   ::nFlags    := nFlags
   ::nSocket   := sqlConnect(cServer, cUser, cPassword, nPort, nFlags, lEmbedded )
   ::lError    := .F.
