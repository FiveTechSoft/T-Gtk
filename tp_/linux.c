/*
 * $Id: linux.c,v 1.1 2009-02-12 22:24:33 riztan Exp $
 */
...
HB_FUNC( P_OPEN ) {
   ...
   fd = open( hb_parcx( 1 ), O_RDWR | O_NOCTTY | O_NDELAY | O_ASYNC );
...
//   int rc;
   ...
   ioctl( hb_parnl( 1 ), TIOCMGET, &status );
...
//   int fd;
   ...
   ioctl( hb_parnl( 1 ), TIOCMSET, status );
