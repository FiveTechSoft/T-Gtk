/* $Id: gtkmarshalers.h,v 1.1 2006-09-08 12:18:45 xthefull Exp $*/
/*
...
/* VOID:POINTER,POINTER,POINTER (./gtkmarshalers.list:85) */
...
/* VOID:POINTER,UINT (./gtkmarshalers.list:86) */
...
/* VOID:STRING (./gtkmarshalers.list:87) */
#define _gtk_marshal_VOID__STRING	g_cclosure_marshal_VOID__STRING

/* VOID:STRING,STRING (./gtkmarshalers.list:88) */
...
/* VOID:STRING,INT,POINTER (./gtkmarshalers.list:89) */

/* VOID:STRING,UINT,FLAGS (./gtkmarshalers.list:90) */
...
/* VOID:UINT,FLAGS,BOXED (./gtkmarshalers.list:91) */
...
/* VOID:UINT,UINT (./gtkmarshalers.list:92) */
...
/* VOID:UINT,STRING (./gtkmarshalers.list:93) */
...
/* VOID:UINT,BOXED,UINT,FLAGS,FLAGS (./gtkmarshalers.list:94) */
...
/* VOID:UINT,OBJECT,UINT,FLAGS,FLAGS (./gtkmarshalers.list:95) */
...
/* VOID:VOID (./gtkmarshalers.list:96) */
