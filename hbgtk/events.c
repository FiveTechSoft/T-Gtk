/* $Id: events.c,v 1.1 2006-09-08 12:18:45 xthefull Exp $*/
/*
    LGPL Licence.
...
HB_FUNC( HARB_SIGNAL_CONNECT ) // widget, se̱al, Self, method a saltar, Connect_Flags, child
{
    ...
    gchar *aMethods[] = { "OnClicked","OnPressed","OnReleased",
                       "OnEnter","OnLeave", "OnToggled",
                       "OnDelete_event","OnDay_selected","OnDay_selected_double_click",
                       "OnMonth_changed","OnNext_month","OnNext_year",
                       "OnPrev_month","OnPrev_year","OnActivate", "OnFocus_out_event","OnKey_press_event",
                       "OnResponse","OnDestroy","OnFocus_in_event","OnChanged","OnValue_changed",
                       "OnMove_slider", "OnExpose_Event", "OnSelect_child", "OnSelection_changed",
                       "OnSwitch_page","OnKey_release_event", "OnGroup_changed","OnRow_Activated",
                       "OnCell_toggled", "OnInsert_At_Cursor", "OnShow_Menu", "OnItem_Activated",
                       "OnConfigure_Event", "OnRealize", "OnUnrealize", "OnCursorChanged",
                       "OnEdited", "OnEvent", "OnEnterNotifyEvent", "OnLeaveNotifyEvent",
                       "OnAccelClosuresChanged", "OnButtonPressEvent", "OnButtonReleaseEvent",
                       "OnCanActivateAccel","OnChildNotify", "OnClientEvent", "OnDestroyEvent",
                       "OnDirectionChanged", "OnEventAfter", "OnFocus",
                       "OnAdd", "OnRemove", "OnSetFocusChild","OnCheckResize",
                       "OnGrabBrokenEvent", "OnGrabFocus", "OnGrabNotify", "OnHide",
                       "OnHierarchyChanged", "OnMap", "OnMapEvent", "OnMnemonicActivate",
                       "OnMotionNotifyEvent", "OnNoExposeEvent", "OnParentSet", "OnPopupMenu",
                       "OnPropertyNotifyEvent", "OnProximityInEvent", "OnProximityOutEvent",
                       "OnScreenChanged", "OnScrollEvent", "OnSelectionClearEvent","OnSelectionGet",
                       "OnSelectionNotifyEvent", "OnSelectionReceived", "OnSelectionRequestEvent",
                       "OnShow", "OnShowHelp", "OnSizeAllocate", "OnSizeRequest", "OnStateChanged",
                       "OnStyleSet", "OnUnMap", "OnUnMapEvent", "OnVisibilityNotifyEvent",
                       "OnWindowStateEvent", "OnActivateDefault", "OnActivateFocus", "OnFrameEvent",
                       "OnKeysChanged", "OnMoveFocus", "OnSetFocus", "OnClose",
                       "OnAcceptPosition", "OnCancelPosition", "OnCycleChildFocus", "OnCycleHandleFocus",
                       "OnMoveHandle", "OnToggleHandleFocus" , "OnAdjustBounds", "OnChangeValue",
                       "OnMoveFocusOut", "OnScrollChild" };
