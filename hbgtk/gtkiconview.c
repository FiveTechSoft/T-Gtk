...
{
  GtkIconView  * iconlist = GTK_ICON_VIEW( hb_parnl( 1 ) );
  GtkTreeModel * model    = GTK_TREE_MODEL( hb_parnl( 2 ) );
...
{
  GtkIconView  * iconlist = GTK_ICON_VIEW( hb_parnl( 1 ) );
  hb_retnl( (glong) gtk_icon_view_get_model( iconlist ) );
}
