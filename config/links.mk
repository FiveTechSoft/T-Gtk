...
#LibCURL for Windows
LIBCURL_INST_FILE=curl-7.31.0-rtmp-ssh2-ssl-sspi-zlib-idn-static-bin-w32
LIBCURL_INST_LNK=http://curl.haxx.se/gknw.net/7.31.0/dist-w32/$(LIBCURL_INST_FILE).zip
endif
#/eof
