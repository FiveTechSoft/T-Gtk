...
$(shell $(strip $(ECHO) $(N) Soporte para LibGD (GD Graphic Library) $(ADD)))
$(shell $(strip $(ECHO) export LIBGD =$(LIBGD)$(ADD)))
$(shell $(strip $(SPACE) $(ADD)))
$(shell $(strip $(ECHO) $(N) Soporte para Haru (Free PDF Library) $(ADD)))
$(shell $(strip $(ECHO) export HPDF =$(HPDF)$(ADD)))
$(shell $(strip $(SPACE) $(ADD)))
